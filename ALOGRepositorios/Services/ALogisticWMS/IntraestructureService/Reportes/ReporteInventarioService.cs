...
public class ReporteInventarioService : IReporteInventarioService
{
    ...
    public ReporteInventarioService(HttpClient httpClient)
    {
        _httpClient = httpClient;
    }

    public async Task<ResultBase<DocumentoBase>> ObtieneReporteDescargaInventario(ConsultaMonitorInventario datosReporteador)
    {
        ...
        var response = await _httpClient.PostAsync($"{Inicializar.UrlApiLogisticWMS}api/ReporteadorInventario/ObtieneReporteDescargaInventario", content);
