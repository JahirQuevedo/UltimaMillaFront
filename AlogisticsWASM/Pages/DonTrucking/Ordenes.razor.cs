...
namespace AlogisticsWASM.Pages.DonTrucking
{
    public partial class Ordenes
    {
        ...
        private ICollection<DtUltimaMillaEnc>? _encabezadosCopia;
        ...
        private List<DtUltimaMillaEnc>? pagedData;
        private List<DtUltimaMillaEnc>? pagedDataCopy;
        ...
        private async Task ObtenerDatos()
        {
            ...
            */
            ...
            {
                _encabezados = new List<DtUltimaMillaEnc>();
            }
            else
            {
            ...
            _ordenesCompletadas = _encabezados.Count(e => e.catTipoEstados.TipoEstado.Equals("T"));
            _ordenesCanceladas = _encabezados.Count(e => e.catTipoEstados.TipoEstado.Equals("C"));
            _ordenesEnProceso = _encabezados.Count(e => e.catTipoEstados.TipoEstado.Equals("P"));
        }
        ...
        public Task BuscarPorCliente(string valor)
        {
            ...
            {
                pagedData = pagedData.Where(d => d.catClientes.RazonSocial.ToUpper().Contains(valor.ToUpper())).ToList();
            }
        ...
        private void EditarOrden(DtUltimaMillaEnc encabezado)
        {
            //_estaEditando = true;
            _encabezadoSeleccionado = new UltimaMillaEncabezadoEditarDTO();
            _encabezadoSeleccionado.Id = encabezado.IdDtUltMillaEnc;
            _encabezadoSeleccionado.FechaSolicitud = encabezado.FechaSolicitud;
            _encabezadoSeleccionado.Viaje = encabezado.Viaje;
            _encabezadoSeleccionado.IdCliente = (int)encabezado.IdCliente;
            _encabezadoSeleccionado.NombreCliente = encabezado.catClientes.RazonSocial;
            ...
            _encabezadoSeleccionado.IdServicio = encabezado.IdCatServicio;
        ...
        private void ObtenerEncabezadoEditado(UltimaMillaEncabezadoEditarDTO encabezadoDto)
        {
            ...
            var encabezado = pagedData?.FirstOrDefault(e => e.IdDtUltMillaEnc == encabezadoDto.Id);

            if (encabezado != null)
            {
                encabezado.IdDtUltMillaEnc = encabezadoDto.Id;
                ...
                encabezado.IdCatServicio = encabezadoDto.IdServicio;
        ...
        private void VerDetalles(DtUltimaMillaEnc encabezado)
        {
            _navigationManager.NavigateTo($"ordenes-detalles/{encabezado.IdDtUltMillaEnc}");
        }
    }
}
